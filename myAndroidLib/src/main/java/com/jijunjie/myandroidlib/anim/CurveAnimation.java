package com.jijunjie.myandroidlib.anim;
...
/**
 * Created by jijunjie on 16/6/22.
 */
public class CurveAnimation extends Animation {
         ...
         */
        public CurveAnimation(float fromXDelta, float toXDelta,
         ...
         *            ABSOLUTE, or a percentage (where 1.0 is 100%) otherwise.
         */
        public CurveAnimation(int fromXType, float fromXValue, int toXType,
        ...
        protected void applyTransformation(float interpolatedTime, Transformation t) {
            float dy = calcBezier(interpolatedTime, mStart.x, mControl.x, mEnd.x);
            float dx = calcBezier(interpolatedTime, mStart.y, mControl.y, mEnd.y);
